<?php class Package extends CI_Controller{
		...
		function search_package(){
			if($this->session->userdata('language')=='english')
				...
				$data['postfix']='_ar';	
			$package_country=$this->input->post('cn_id');
			$package_country_name=$this->input->post('country');
			$package_arrival_date=$this->input->post('arrival');
			$package_dept_date=$this->input->post('departure');
