...
<div class="col-sm-12">
<p>
<input type="text" id="package_title" name="package_title" class="required" value="<?php echo $package_details['package_title'];?>" placeholder="Package Title">
</p>
</div>
...
<div class="col-sm-6">
<p>
<input type="text" id="dept_date" name="dept_date" value="<?php echo $package_details['dept_date'];?>" class="required" placeholder="Departure Date">
<script>
  $(function() {
...
<div class="col-sm-6">
<p>
<input type="text" id="arr_date" name="arr_date"  value="<?php echo $package_details['arr_date'];?>" class="required" placeholder="Arrival Date">
</p>
<script>
  $(function() {
    $( "#arr_date" ).datepicker();
...
<div class="col-sm-6">
<p>
<input type="text" id="package_cost_adult" value="<?php echo $package_details['package_cost_adult'];?>" name="package_cost_adult" class="required" placeholder="Cost Per Adult">
</p>
<p>
<input type="text" id="package_cost_child" value="<?php echo $package_details['package_cost_child'];?>" name="package_cost_child" class="required" placeholder="Cost Per Child">
</p>
<p>
<input type="text" id="package_cost_infant" value="<?php echo $package_details['package_cost_infant'];?>" name="package_cost_infant" class="required" placeholder="Cost Per Infant">
</p>
</div>
<div class="col-sm-6">
<p>
<input type="text" id="number_of_seats_adult" value="<?php echo $package_details['number_of_seats_adult'];?>" name="number_of_seats_adult" class="required" placeholder="Number of Seats Available for Adults">
</p>
<p>
<input type="text" id="number_of_seats_child" name="number_of_seats_child" class="required" value="<?php echo $package_details['number_of_seats_child'];?>" placeholder="Number of Seats Available for Childs">
</p>
<p>
<input type="text" id="number_of_seats_infant" value="<?php echo $package_details['number_of_seats_infant'];?>" name="number_of_seats_infant" class="required" placeholder="Number of Seats Available for Infants">
</p>
</div>
</div>
<div class="row">
...
<select id="country_id" name="country_id" class="required" data-placeholder="Destination Country">
...
<p>
<textarea id="package_desc"  name="package_desc" class="required" placeholder="Package Description"><?php echo $package_details['package_desc'];?></textarea>
</p>
<div class="row">
<div class="col-sm-6">
