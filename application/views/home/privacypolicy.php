					...
					<div class="page-header-inner">
						...
						<nav class="page-header-nav">
							<ul class="custom-list clearfix">
								...
								<li class="active"><a href="<?php echo base_url('index.php/privacypolicy'); ?>"><?php echo $this->lang->line('privacy_policy'); ?></a></li>
								<li><a href="<?php echo base_url('index.php/termsconditions'); ?>"><?php echo $this->lang->line('terms_and_conditions'); ?></a></li>
							</ul>
						</nav>
					</div>
				</div>
