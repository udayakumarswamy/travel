<!DOCTYPE html>
<html <?php if($this->session->userdata('language')=='arabic'){ echo 'dir="rtl" lang="ar"'; } ?>>
<head>
	...
	if($this->session->userdata('language')=='arabic'){
		?>
	<!-- STYLESHEETS : begin -->
	<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/library/css/ar/bootstrap.min.css">
	<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/library/css/ar/font-awesome.min.css">
	<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/library/css/ar/owl.carousel.css">
	<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/library/css/ar/animate.custom.css">
	<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/library/css/ar/magnific-popup.css">
	<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/library/css/ar/style.css">
	<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/library/css/ar/skins/default.css">
		<?php
	}
	else {
		?>
	<!-- STYLESHEETS : begin -->
	<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/library/css/en/bootstrap.min.css">
	<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/library/css/en/font-awesome.min.css">
	<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/library/css/en/owl.carousel.css">
	<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/library/css/en/animate.custom.css">
	<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/library/css/en/magnific-popup.css">
	<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/library/css/en/style.css">
	<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/library/css/en/skins/default.css">
		<?php
	}
	?>
	...
	if(valid==1){
		$.ajax({
			...
			success: function(obj){
	          ...
	          window.location='<?php echo base_url();?>index.php/landing/thankyou';
	      }
	      else {
	      	$(".success").css('display','none');
	      	$(".warning").css('display','block');
						...
						<nav class="header-nav">
							<ul>
								<li class="has-submenu" <?php if($this->session->userdata('language')=='arabic'){?> dir="rtl" <?php } ?>>
									<a href="<?php echo base_url();?>" <?php if($this->session->userdata('language')=='arabic'){?> dir="rtl" <?php } ?>><?php echo $this->lang->line('home');?></a>
								</li>
								...
								<li <?php if($this->session->userdata('language')=='arabic'){?> dir="rtl" <?php } ?>><a href="<?php echo base_url('index.php/contactus'); ?>" <?php if($this->session->userdata('language')=='arabic'){?> dir="rtl" <?php } ?>><?php echo $this->lang->line('contact_us');?></a></li>
								<li <?php if($this->session->userdata('language')=='arabic'){?> dir="rtl" <?php } ?>><a href="<?php echo base_url('index.php/privacypolicy'); ?>" <?php if($this->session->userdata('language')=='arabic'){?> dir="rtl" <?php } ?>><?php echo $this->lang->line('privacy_policy');?></a></li>
								<li <?php if($this->session->userdata('language')=='arabic'){?> dir="rtl" <?php } ?>><a href="<?php echo base_url('index.php/termsconditions'); ?>"><?php echo $this->lang->line('terms_and_conditions');?></a></li>
							</ul>
						</nav>
					</div>
					<!-- HEADER MENU : end -->
