            ...
            <ul class="sidebar-menu" id="nav-accordion">
				...
				<li class="sub-menu">
                    <a class="active" href="javascript:;">
					 ...
					 <ul class="sub">
                        <li><a href="<?php echo base_url();?>index.php/admin/list_package">Package List</a></li>
                        <li><a href="<?php echo base_url();?>index.php/admin_package/add_package">Add Package</a></li>
						<li><a href="<?php echo base_url();?>index.php/admin_package/list_amenities">List Amenities</a></li>
                        <li><a href="<?php echo base_url();?>index.php/admin_package/add_amenities">Add Amenities</a></li>
                    </ul>
				...
				<li class="sub-menu">
                    <a class="active" href="javascript:;">
					 ...
					 <ul class="sub">
                        <li><a href="<?php echo base_url();?>index.php/cms/add_cms">Add CMS Page</a></li>
                        <li><a href="<?php echo base_url();?>index.php/cms/list_cms">List of CMS Page</a></li>
