...
<html>
	<head>
        ...
        <title>Home | Casa - Swap, Book &amp; Rent HTML5 Template</title>
...
/*function makeAjaxCall(){
	$.ajax({
		type: "post",
		url: "<?php //echo base_url();?>index.php/home/registration",
		cache: false,				
...
$(document).ready(function(){
	...
	if(valid==1){
		$.ajax({
			type:"POST",
			url:'<?php echo base_url();?>index.php/landing/login',
    ...
    $('#userregistrationForm').submit(function(evnt){
	    ...
	    if(valid==1){
			...
			$.ajax({
			   type: "POST",
			   url: "<?php echo base_url();?>index.php/landing/registration",
			   data: {'email_address':email_address,'password':password,"user_name":user_name},
			   dataType:"json",
			   success: function(obj){
				 //  var obj = JSON.parse(data);
				  ...
				  // alert("The registration processed successfully!")
				   $(".warning").css('display','none');
				   $("#registration_success").text("The registration processed successfully!");
 ...
 $("#user_name").keyup(function(){
  ...
  $.ajax({
   type: "POST",
   url: "<?php echo base_url();?>index.php/landing/check_user",
   ...
   success: function(msg){
    ...
    {
	    $("#registration_error").text('This username already exists');
		$(".warning").css('display','block');
			...
			<div class="container">
				<div class="header-inner clearfix">
					...
					<div class="header-branding">
						<a href="index.html"><img src="<?php echo base_url();?>assets/dummies/logo.png" alt="Casa"></a>
					</div>
					<!-- HEADER BRANDING : end -->
							...
							<div class="header-register">
								...
								<div class="header-form">
									...
									<form name="userregistrationForm" id="userregistrationForm"  class="default-form" >
										...
										<p class="form-row">
											<input class="required" type="text" placeholder="Username"  id="user_name" name="user_name" value="<?php echo set_value('user_name'); ?>">
										</p>
										<p class="form-row">
											<input class="required email" type="text" placeholder="Email"  id="email_address" name="email_address" value="<?php echo set_value('email_address'); ?>">
										</p>
										<p class="form-row">
											<input class="required" type="password" placeholder="Password" id="password" name="password" value="<?php echo set_value('password'); ?>">
										</p>
										<p class="form-row">
											<input class="required" type="password" placeholder="Repeat Password" id="con_password" name="con_password" value="<?php echo set_value('con_password'); ?>" />
										</p>
										<p class="form-row">
											User<input class="required" type="radio"  name="user_type" value="1" checked="checked" />&nbsp;Agent<input class="required" type="radio"  name="user_type" value="2" />
										</p>
										<p class="form-row">
								...
								<div class="header-form">
									<form name="userloginForm" id="userloginForm" class="default-form">
										 ...
										 <p class="alert-message warning"><i class="ico fa fa-exclamation-circle"></i><span class="error"></span><i class="fa fa-times close"></i></p>	
                                          <p class="form-row">
											<input class="required email" type="text" placeholder="Email"  id="email" name="email" >
										  </p>
                                          <p class="form-row">
											<input class="required" type="password" placeholder="Password"  id="pass" name="pass" >
										</p>
                                        <p class="form-row">
                                          <button class="submit-btn button" id="btn_submit"><i class="fa fa-power-off"></i> Login</button>
                                        </p>
							...
							<ul class="custom-list tab-content-list browse-contents">
								<li class="tab-content active">
									...
									<div class="browse-properties">
										...
										<ul class="custom-list tab-content-list">
											<li class="tab-content active"><img src="<?php echo base_url();?>assets/dummies/map_01.jpg" alt=""></li>
											<li class="tab-content"><img src="<?php echo base_url();?>assets/dummies/map_02.jpg" alt=""></li>
											<li class="tab-content"><img src="<?php echo base_url();?>assets/dummies/map_03.jpg" alt=""></li>
										</ul>
									...
									<div class="browse-destinations">
										...
										<div class="row">
											<div class="col-sm-4">
												...
												<div class="top-destination">
													<img class="destination-thumb" src="<?php echo base_url();?>assets/dummies/top_destination_01.jpg" alt="">
											...
											<div class="col-sm-4">
												...
												<div class="top-destination">
													<img class="destination-thumb" src="<?php echo base_url();?>assets/dummies/top_destination_02.jpg" alt="">
													<div class="top-destination-inner">
														<h3>New York</h3>
														<a href="#" class="button"><i class="fa fa-list-ul"></i> Browse</a>
													</div>
											...
											<div class="col-sm-4">
												...
												<div class="top-destination">
													<img class="destination-thumb" src="<?php echo base_url();?>assets/dummies/top_destination_03.jpg" alt="">
													<div class="top-destination-inner">
														<h3>Paris</h3>
														<a href="#" class="button"><i class="fa fa-list-ul"></i> Browse</a>
													</div>
										...
										<div class="row">
											<div class="col-sm-4">
												...
												<div class="top-destination">
													<img class="destination-thumb" src="<?php echo base_url();?>assets/dummies/top_destination_04.jpg" alt="">
													<div class="top-destination-inner">
														<h3>Rome</h3>
														<a href="#" class="button"><i class="fa fa-list-ul"></i> Browse</a>
													</div>
											...
											<div class="col-sm-4">
												...
												<div class="top-destination">
													<img class="destination-thumb" src="<?php echo base_url();?>assets/dummies/top_destination_05.jpg" alt="">
													<div class="top-destination-inner">
														<h3>Dubai</h3>
														<a href="#" class="button"><i class="fa fa-list-ul"></i> Browse</a>
													</div>
											...
											<div class="col-sm-4">
												...
												<div class="top-destination">
													<img class="destination-thumb" src="<?php echo base_url();?>assets/dummies/top_destination_06.jpg" alt="">
													<div class="top-destination-inner">
														<h3>Tokyo</h3>
														<a href="#" class="button"><i class="fa fa-list-ul"></i> Browse</a>
													</div>
			...
			<div class="container">
				<div class="testimonials-inner">
					...
					<div class="testimonial-list">
						...
						<!-- TESTIMONIAL 2 : begin -->
						<div class="testimonial">
							<p class="portrait"><img src="<?php echo base_url();?>assets/dummies/portrait_02_200.jpg" alt="Jenny"></p>
							<blockquote class="quote">
								<p>I had the best time of my life and all thanks to Casa! It’s so amazing, everyone should try it!</p>
								<footer><cite>Jenny - Toronto, Canada</cite></footer>
							</blockquote>
						...
						<!-- TESTIMONIAL 3 : begin -->
						<div class="testimonial">
							<p class="portrait"><img src="<?php echo base_url();?>assets/dummies/portrait_03_200.jpg" alt="Jenny"></p>
							<blockquote class="quote">
								<p>I had the best time of my life and all thanks to Casa! It’s so amazing, everyone should try it!</p>
								<footer><cite>Jenny - Toronto, Canada</cite></footer>
							</blockquote>
